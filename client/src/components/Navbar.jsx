...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-16 lg:px-36 py-5' >
      ...
      <img src={assets.logo} alt="" className='w-36 h-auto'/>
        ...
        <div className='flex items-center gap-8'>
            ...
            {
                !user ? (
                    <button onClick={openSignIn} className='px-4 py-1 sm:py-2 bg-[#F84565] hover:bg-[#D63854] transition rounded-full font-medium cursor-pointer'>Login</button>
                ) : (
                   <UserButton>
